...
- self在对象的方法中表示当前对象本身，如果通过对象调用一个方法，
   那么该对象会自动传入当前放的第一个参数中
- self并不是关键字，只是一个用于接受对象的普通参数，理论上可以用任何一个普通变量名代替
- 方法中有self形参的方法称为非绑定类的方法，可以通过对象访问，
    没有self的是绑定类的方法，只能通过类访问
- 使用类访问绑定类的方法是，如果类方法中需要访问当前类的成员，可以通过__class__成员名进行访问
...
- 继承与被继承的概念：
    - 被继承的类叫父类，也叫基类，也叫超类，这几个都可以
    - 用于继承的类，叫子类，也叫派生类
    - 继承与被继承的关系：一定存在一个 is-a 关系
- 继承的语法，参见oop-2.1pynb
- 继承的特征
